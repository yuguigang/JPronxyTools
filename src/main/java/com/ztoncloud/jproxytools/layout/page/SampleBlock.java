...
public class SampleBlock extends VBox {
    ...
    protected ObservableValue<String> observableTitle;
    protected ObservableValue<String> observableText;


    public SampleBlock(String title, Node content) {
        this(title, content, null);
    }
    public SampleBlock(ObservableValue<String> observableTitle, Node content) {
        this(observableTitle, content, null);
    }

    public SampleBlock(ObservableValue<String> observableTitle, Node content, ObservableValue<String> observableText) {
        titleLabel = new Label();
        titleLabel.textProperty().bind(observableTitle);
        ...
        if (observableText != null ) {
            var text = new Text();
            text.textProperty().bind(observableText);
            descriptionText = new TextFlow(text);
